...
class TrtEnhance(object):
    ...
    def convert(self, rebuild=True, ):
        ...
        self.build_fp16_network(rebuild)
        self.build_fp16_plugin_network(rebuild)
    ...
    def build_fp16_plugin_network(self, rebuild):

        trt_model_file = os.path.join(self.trt_model_path, "TrOCR.fp16.plugin.plan")
        if rebuild:
            builder = trt.Builder(self.logger)
    ...
    def build_fp16_network(self, rebuild):
